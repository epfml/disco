...
DeAI is easy-to-use mobile & web code. The latest version of DeAI is always running on the following link, [directly in your browser](https://epfml.github.io/DeAI/), for mobile and desktop:
