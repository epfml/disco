      ...
      const steps: DriveStep[] = [
        {
          ...
          popover: {
            ...
            description:
              "Would you like a quick tour of DISCO? You can always come back to this tutorial by clicking on the help button.",
            align: "end",
          },
        },
        {
          popover: {
            ...
            description:
              "This is a collaborative platform for training machine learning models while keeping your data private. You can use the side bar to navigate through the website.",
            align: "start",
          },
        },
        {
        ...
        },
        {
          ...
          popover: {
            ...
            description:
              "Create a DISCOllaborative by defining the ML task and base model so that other users can join and contribute.",
            align: "start",
          },
        },
        {
          ...
          popover: {
            ...
            description:
              "Download or load models you've trained to use or evaluate them.",
            align: "start",
          },
        },
        {
        ...
        },
        {
          popover: {
            title: "Task Overview",
            description:
              "Here you can find a description of the task as well as the model being trained.",
          },
        },
        {
        ...
        },
        {
          ...
          popover: {
            ...
            description:
              "This page describes what kind of data can be used to train the model. This is where you can connect your data. Note that data connected here is only used locally and is never uploaded or shared with anyone.",
          },
        },
        {
          ...
          popover: {
            title: "Example Data",
            description:
              "If needed you can find a sample dataset here if you don't have your own. Perfect for testing and experimenting!",
          },
        },
        {
          ...
          popover: {
            ...
            description:
              'Most of the times you will want to connect your data by "Group", when your data is organized by categories. If there are a lot of categories you can use a CSV file listing the class of each file.',
          },
        },
        {
        ...
        },
        {
          ...
          popover: {
            title: "Training Mode",
            description:
              "This section allows you to choose how the model will be trained. Select between collaborative or local training modes.",
          },
        },
        {
          ...
          popover: {
            ...
            description:
              "Train the model together with other users in a shared session.",
            align: "center",
            side: "top",
          },
        },
        ...
        },
        {
          ...
          popover: {
            title: "The Model Library",
            description:
              "You can find all your trained models in the Model Library for future use.",
            align: "center",
          },
        },
        {
