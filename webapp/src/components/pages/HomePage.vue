  ...
  <div class="lg:mx-8">
    ...
    >
      ...
      <div class="flex flex-col justify-center items-center space-y-4">
        <div
          class="mx-auto w-full h-full min-w-[250px] max-w-[640px] max-h-[264px]"
        >
          <DiscoLogo v-if="themeStore.current == 'dark'" />
          <DiscoGIF v-else class="pb-4" />
        </div>
        <div class="text-center">
          <span class="font-disco text-xl md:text-3xl lg:text-4xl">
    ...
    >
      ...
      <MultiDeviceIcon
        class="w-2/5 h-2/5 min-w-[250px] drop-shadow-[0_5px_5px_rgba(0,0,0,0.25)]"
      />
    </div>
    <!-- 3nd screen -->
    <div class="mb-40 lg:pb-40 lg:mb-0 lg:h-dvh flex flex-col justify-center">
      <div class="flex flex-col items-around justify-start w-full">
        ...
        <div
          class="grid grid-cols-1 lg:grid-cols-3 gap-x-16 gap-y-8 place-items-start"
        >
          <div
            class="flex flex-col justify-center items-center text-center w-full"
          >
            <span
              class="text-2xl font-bold text-heading-light dark:text-heading-dark"
            >
              Connect your data
            </span>
            <img
          ...
          >
            ...
            >
              ...
              <span
                v-tippy="{
                  content:
                    'This is how we call collaborative training sessions in DISCO.',
                  placement: 'top',
                }"
    ...
    <div class="mb-40 lg:mb-0 lg:h-dvh flex flex-col justify-center gap-16">
      ...
      <div
        class="grid grid-cols-1 lg:grid-cols-2 gap-8 place-items-center pb-20"
      >
    ...
    >
      <div class="w-full flex flex-col justify-center text-center items-center">
        ...
        <span class="text-base lg:text-lg mt-4 w-full lg:w-2/5 max-w-[500px]">
          Disco supports a wide array of deep learning architectures and tasks
          from image classification to training Transformers model.
        </span>
      </div>
      <div
        class="grid grid-cols-1 lg:grid-cols-3 place-items-center gap-4 gap-y-8"
      >
        <span
          class="text-3xl font-bold text-heading-light dark:text-heading-dark"
        >
          Powered by
        </span>
        <a
        ...
        <a class="flex justify-center" href="https://onnx.ai/" target="_blank">
    ...
    <div class="lg:h-dvh flex flex-col gap-16 justify-start items-center">
      ...
      <div class="flex flex-col gap-y-8 text-center items-center">
        ...
        <span
          class="mt-4 text-3xl font-bold text-heading-light dark:text-heading-dark"
        >
          Supported by
        </span>
        <div class="w-3/4 grid grid-cols-2 place-items-center">
    ...
    >
      ...
      <div class="flex flex-col items-center lg:items-start gap-2 text-center">
        <span
          class="font-disco text-4xl lg:text-5xl font-bold text-heading-light dark:text-heading-dark"
        >
        ...
        <span
          class="text-center lg:text-left w-full max-w-[500px] text-base lg:text-lg"
        >
        ...
        <div class="mt-4 flex flex-wrap justify-center gap-x-4">
          ...
          <a
            ...
            target="_blank"
            class="px-6 py-3 min-w-32 text-xl dark:text-white tracking-wide font-disco outline outline-1 outline-slate-400 rounded-full hover:outline-2"
          >
            Contact us
          </a>
        </div>
