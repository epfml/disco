 ...
 */
    it("CC improves with more iterations", async () => {
        ...
        expect(Math.abs(r50.result - honest))
            .to.be.lessThan(Math.abs(r1.result - honest));
    });
    ...
    it("iterations improve CC but not percentile", async () => {
        ...
        expect(Math.abs(r5.result))
            .to.be.lessThanOrEqual(Math.abs(r1.result));
    });
    ...
    it("percentile sensitivity to tau parameter", async () => {
        ...
        expect(Math.abs(rLow.result - 1))
            .to.be.lessThan(Math.abs(rHigh.result - 1));
    });
    ...
    it("CC handles symmetric attacks better than percentile", async () => {
        ...
        expect(Math.abs(resCC.result - honest))
            .to.be.lessThan(Math.abs(resPC.result - honest));
    });
    ...
    it("percentile is sensitive to honest variance", async () => {
        ...
        expect(Math.abs(resCC.result - honestMean))
            .to.be.lessThan(Math.abs(resPC.result - honestMean));
    });
});