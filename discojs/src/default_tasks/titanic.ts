  ...
  getTask (): Task {
    return {
      ...
      displayInformation: {
        ...
        dataExampleText: 'Below one can find an example of a datapoint taken as input by our model. In this example, the person is young man named Owen Harris that unfortunately perished with the Titanic. He boarded the boat in South Hamptons and was a 3rd class passenger. On the testing & validation page, the data should not contain the label column (Survived).',
        dataExample: [
