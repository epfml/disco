    ...
    return {
      ...
      displayInformation: {
        ...
        summary: {
          ...
          overview: "You can train a GPT-2 model in your browser and in a collaborative manner on any textual dataset. As an example, you can use the Wikitext-103 dataset, composed of Wikipedia articles, widely used in natural language modeling, which you can download <a class='underline text-blue-400' target='_blank' href='https://dax-cdn.cdn.appdomain.cloud/dax-wikitext-103/1.0.1/wikitext-103.tar.gz'>here</a>. More information on how to connect the dataset at the next step."
        },
        ...
        dataFormatInformation: 'You can use any natural language dataset you like. For example the Wikitext-103 dataset is organized as a large text file, with each line representing a segment of raw text from Wikipedia articles.',
