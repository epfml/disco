  ...
  <div>
    ...
    >
      <div class="flex items-center space-x-4 md:space-x-0">
        ...
        <h1 class="text-2xl font-medium">LUS-COVID Model</h1>
      </div>
    </header>
    <div
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <span class="ml-2 text-sm"> Titanic Model Information </span>
...
export default {
  ...
  methods: {
    ...
    goToModelDescription() {
      this.$router.push({ path: "/lus-covid-model/description" });
    },
    handleResize() {
