          ...
          <div class="flex items-center justify-between p-4">
            ...
            >
              ...
              <div
                ...
                :class="{
                  'translate-x-0  bg-white dark:bg-primary-100': !choiceNewModel,
                  'translate-x-6 bg-primary-light dark:bg-primary': choiceNewModel,
                }"
              ></div>
            </button>
          </div>
...
export default {
  ...
  methods: {
    ...
    async optionNewModel() {
      this.choiceNewModel = !this.choiceNewModel;
      if (this.choiceNewModel) {
  ...
  async mounted() {
    ...
    this.$nextTick(async function () {
      ...
      if (modelInfo != undefined) {
        const savedModelPath = "indexeddb://".concat(saveName);
        savedModel = await tf.loadLayersModel(savedModelPath);
        if (savedModel != null) {
