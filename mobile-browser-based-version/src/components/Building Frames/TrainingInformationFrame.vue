    ...
    <div class="grid grid-cols-2 p-4 space-x-4 lg:gap-2">
      <div class="col-span-1 bg-white rounded-md dark:bg-darker">
        ...
        <p class="p-4">
          <span
            ...
            v-bind:id="training_informant.get_valValidationAccuracyID()"
            >0</span
          >
        ...
        <div class="relative p-4">
          <canvas
            v-bind:id="training_informant.get_chartValidationAccuracyID()"
          ></canvas>
        </div>
      </div>
      ...
      <div class="col-span-1 bg-white rounded-md dark:bg-darker">
        ...
        <p class="p-4">
          <span
            class="text-2xl font-medium text-gray-500 dark:text-light"
            v-bind:id="training_informant.get_valTrainingAccuracyID()"
            >0</span
          >
          <span class="text-sm font-medium text-gray-500 dark:text-primary"
        ...
        <div class="relative p-4">
          <canvas
            v-bind:id="training_informant.get_chartTrainingAccuracyID()"
          ></canvas>
        </div>
      </div>
    </div>
      ...
      <div id="mapHeader">
        <ul class="grid grid-cols-1 p-4">
          <li
            ...
            v-for="(message, index) in training_informant.messages"
            :key="index"
          >
  ...
  <div class="grid grid-cols-1 gap-8 p-4 lg:grid-cols-2 xl:grid-cols-4">
    ...
    >
      <div>
        ...
        <span class="text-xl font-semibold">{{
          training_informant.nbrUpdatesWithOthers
        }}</span>
      </div>
      <div>
        <span>
    ...
    >
      <div>
        ...
        <span class="text-xl font-semibold"
          >{{ training_informant.waitingTime }} sec</span
        >
      </div>
      <div>
        <span>
    ...
    >
      <div>
        ...
        <span class="text-xl font-semibold">{{
          training_informant.nbrWeightRequests
        }}</span>
      </div>
      <div>
        <span>
    ...
    >
      <div>
        ...
        <span class="text-xl font-semibold">{{
          training_informant.whoReceivedMyModel.size
        }}</span>
      </div>
      <div>
        <span>
