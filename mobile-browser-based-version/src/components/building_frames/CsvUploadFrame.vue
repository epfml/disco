...
export default {
  ...
  data() {
    return {
      galleryName: "gallery_".concat(this.codeName),
      fileTemplName: "file-template_".concat(this.codeName),
      imageTemplName: "image-template_".concat(this.codeName),
      emptyName: "empty_".concat(this.codeName),
      hiddenInputName: "hidden-input_".concat(this.codeName),
      uploadButtonName: "uploadButton_".concat(this.codeName),
    };
  },
  methods: {
    addFile(target, file) {
      ...
      //console.log(FILES[Object.keys(obj)[0]])
    },
