...
export const displayInformation = {
  ...
  summary:
    "Life started by learning numbers, well you've come a full circle! let's get back to it ! From the MNIST dataset of handwritten digits, can you identify them?",
