...
export class TrainingInformant {
     ...
     * @param {String} task_name the task's name.
     */
    constructor(length, task_name) {
        ...
        this.validationAccuracyChart = null //new TrainingChart("validationAccuracy_".concat(task_name), "Validation Accuracy")
        this.validationAccuracy = null
        
        // training accuracy chart
        this.trainingAccuracyChart = null // new TrainingChart("trainingAccuracy_".concat(task_name), "Training Accuracy")
     ...
     * @param {String} peer_name the peer's name to whom I recently shared my model to. 
     */
     ...
     * @param {Number} nbr_updates the number of updates I did thanks to other peers contribution since the last update of the parameter. 
     */
     ...
     * @param {Number} nbr_requests the number of weight requests I received since the last update of the parameter.
     */
     ...
     */
    initializeCharts() {
        this.validationAccuracyChart = new TrainingChart("validationAccuracy_".concat(this.task_name), "Validation Accuracy");
        this.trainingAccuracyChart = new TrainingChart("trainingAccuracy_".concat(this.task_name), "Training Accuracy");
    }
     ...
     */
    updateCharts(_epoch, _validationAccuracy, _trainingAccuracy) {
        console.log(this)
        this.validationAccuracyChart.updateGraph(_epoch, _validationAccuracy)
        this.trainingAccuracyChart.updateGraph(_epoch, _trainingAccuracy)
    }

    /**
     * Returns the chart's training accuracy ID
     */
    get_chartTrainingAccuracyID() {
        return "chart_trainingAccuracy_".concat(this.task_name)
    }

    /**
     * Returns the chart's training accuracy ID
     */
    get_valTrainingAccuracyID() {
        return "val_trainingAccuracy_".concat(this.task_name)
    }

    /**
     * Returns the chart's validation accuracy ID
     */
    get_chartValidationAccuracyID() {
        return "chart_validationAccuracy_".concat(this.task_name)
    }

    /**
     * Returns the chart's validation accuracy ID
     */
    get_valValidationAccuracyID() {
        return "val_validationAccuracy_".concat(this.task_name)
    }
}