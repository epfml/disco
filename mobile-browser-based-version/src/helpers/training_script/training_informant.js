...
export class TrainingInformant {
     ...
     */
    initializeCharts() {
        this.validationAccuracyChart = new TrainingChart("validationAccuracy_".concat(this.taskName), "Validation Accuracy");
        this.trainingAccuracyChart = new TrainingChart("trainingAccuracy_".concat(this.taskName), "Training Accuracy");
    }
