...
export default function helperJoinTraining(training_data){
...
async function train(model, image_uri, labels) {
    ...
    const trainData = getTrainData(image_uri, labels);
    ...
    const ui = null //todo: use Paul's training plot from upload csv
...
function onIteration(name, epoch, logs){
    console.log(name +" " +epoch + " "+ logs)
}
