        ...
        <div class="col-span-1 bg-white rounded-lg dark:bg-darker">
          ...
          <div class="relative p-4">
            <span class="text-sm text-gray-500 dark:text-light"
              >Verum ad istam omnem orationem brevis est defensio. Nam quoad
              aetas M. Caeli dare potuit isti suspicioni locum, fuit primum
              ipsius pudore, deinde etiam patris diligentia disciplinaque
              munita. Qui ut huic virilem togam deditšnihil dicam hoc loco de
              me; tantum sit, quantum vos existimatis; hoc dicam, hunc a patre
              continuo ad me esse deductum; nemo hunc M. Caelium in illo aetatis
              flore vidit nisi aut cum patre aut mecum aut in M. Crassi
              castissima domo, cum artibus honestissimis erudiretur.</span
            >
          </div>
        </div>
      </div>
        ...
        <div class="col-span-1 bg-white rounded-lg dark:bg-darker">
          ...
          <div class="relative p-4">
            <span class="text-sm text-gray-500 dark:text-light"
              ...
              lingua positae ob orbe eoo monte Amano disparantur.</span
            >
          </div>
        </div>
      </div>
        ...
        <div class="col-span-1 bg-white rounded-lg dark:bg-darker">
          ...
          <div class="relative p-4">
            <span class="text-sm text-gray-500 dark:text-light"
              ...
              conplicandis negotiis artifex dirus, unde ei Catenae inditum est
              cognomentum, vicarium ipsum eos quibus praeerat adhuc defensantem
              ad sortem periculorum communium traxit. et instabat ut eum quoque
              cum tribunis et aliis pluribus ad comitatum imperatoris vinctum
              perduceret: quo percitus ille exitio urgente abrupto ferro eundem
              adoritur Paulum. et quia languente dextera, letaliter ferire non
              potuit, iam districtum mucronem in proprium latus inpegit. hocque
              deformi genere mortis excessit e vita iustissimus rector ausus
              miserabiles casus levare multorum.</span
            >
          </div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      title: "lus-covid-desc",
    };
  },
  methods: {
      goToTraining() {
          this.$router.push({ path: "/lus-covid-model/training" });
      }
  },
};
</script>